...
class BoostContractConan(ConanFile):
    name = "boost-contract"
    description = "Contract programming for C++. All contract programming features are supported"
    license = "BSL-1.0"
    url = "https://github.com/conan-io/conan-center-index"
    homepage = "https://www.boost.org/"
    topics = ("boost", "correctness")
    ...
    def generate(self):
        ...
        tc.cache_variables["CMAKE_PROJECT_boost_contract_INCLUDE"] = os.path.join(self.source_folder, os.pardir, "conan_project_include.cmake")
        tc.generate()
        deps = CMakeDeps(self)
        deps.generate()
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "boost_contract")
        self.cpp_info.set_property("cmake_target_name", "Boost::contract")
        self.cpp_info.libs = ["boost_contract"]
        self.cpp_info.defines = [
            "BOOST_CONTRACT_NO_LIB",
            "BOOST_CONTRACT_DYN_LINK" if self.options.shared else "BOOST_CONTRACT_STATIC_LINK"]

...
class BoostFunctionTypesConan(ConanFile):
    ...
    description = "Classify, decompose and synthesize function, function pointer, function reference and pointer to member types"
    license = "BSL-1.0"
    url = "https://github.com/conan-io/conan-center-index"
    homepage = "https://www.boost.org/"
    topics = ("boost", "generic", "metaprogramming", "header-only")
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "boost_function_types")

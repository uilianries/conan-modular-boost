...
class BoostIntervalConan(ConanFile):
    name = "boost-interval"
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "boost_numeric_interval")
        self.cpp_info.set_property("cmake_target_name", "Boost::numeric_interval")

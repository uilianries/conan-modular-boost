...
class BoostFuncionalConan(ConanFile):
    name = "boost-functional"
    description = "A family of class templates that are function object wrappers"
    license = "BSL-1.0"
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "boost_functional")

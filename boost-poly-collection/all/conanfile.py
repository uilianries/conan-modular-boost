...
class BoostPolyCollectionConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires(f"boost-type-erasure/{self.version}")
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "boost_poly_collection")

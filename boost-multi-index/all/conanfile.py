...
class BoostMultiIndexConan(ConanFile):
    name = "boost-multi-index"
    description = "A class template named multi_index_container which enables the construction of containers"
    license = "BSL-1.0"
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "boost_multi_index")

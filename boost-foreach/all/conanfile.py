...
class BoostForEachConan(ConanFile):
    name = "boost-foreach"
    description = "It iterates over sequences for us, freeing us from having to deal directly with iterators or write predicates"
    license = "BSL-1.0"
    url = "https://github.com/conan-io/conan-center-index"
    homepage = "https://www.boost.org/"
    topics = ("boost", "algorithms", "emulation", "header-only")
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "boost_foreach")

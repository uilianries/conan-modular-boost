...
class BoostLocalFunctionConan(ConanFile):
    ...
    description = "Program functions locally, within other functions"
    license = "BSL-1.0"
    ...
    def requirements(self):
        ...
        self.requires(f"boost-scope-exit/{self.version}")
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "boost_local_function")

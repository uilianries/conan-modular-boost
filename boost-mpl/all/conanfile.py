...
class BoostMPLConan(ConanFile):
    name = "boost-mpl"
    description = "The Boost.MPL library is a general-purpose, high-level C++ template metaprogramming framework of compile-time algorithms"
    license = "BSL-1.0"
    url = "https://github.com/conan-io/conan-center-index"
    homepage = "https://www.boost.org/"
    topics = ("boost", "metaprogramming", "header-only")
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "boost_mpl")

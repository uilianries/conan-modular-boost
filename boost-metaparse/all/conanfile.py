...
class BoostMetaparseConan(ConanFile):
    ...
    description = "Generate compile time parsers parsing embedded DSL code as part of the C++ compilation process"
    license = "BSL-1.0"
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "boost_metaparse")

...
class BoostFormatConan(ConanFile):
    name = "boost-format"
    description = "The format library provides a type-safe mechanism for formatting arguments"
    license = "BSL-1.0"
    url = "https://github.com/conan-io/conan-center-index"
    homepage = "https://www.boost.org/"
    topics = ("boost", "string", "io", "header-only")
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_file_name", "boost_format")
